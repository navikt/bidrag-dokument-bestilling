...
import no.nav.bidrag.dokument.bestilling.model.MDC_KORRELASJONSID
...
class KorrelasjonsIdAspect {
    ...
    @Before(value = "execution(* no.nav.bidrag.dokument.bestilling.hendelse.DokumentHendelseLytter.*(..))")
    ...
    @After(value = "execution(* no.nav.bidrag.dokument.bestilling.hendelse.DokumentHendelseLytter.*(..))")
