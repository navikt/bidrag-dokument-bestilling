...
class SjablongService(val sjablonConsumer: SjablonConsumer) {
    ...
    fun hentSjablonGrunnlagForskuddSjablongForPeriode(periodeFra: LocalDate, tomDato: LocalDate?): List<GrunnlagForskuddPeriode> {
        val sjablonger = sjablonConsumer.hentSjablonger()!!
        val grenseFullForskudd = sjablonger.hentSjablongForTomDato(SjablongType.ØVRE_INNTEKTSGRENSE_FOR_FULLT_FORSKUDD, tomDato)!!
        val forskudd75ProsentEnslig = sjablonger.hentSjablongForTomDato(SjablongType.ØVRE_INNTEKTSGRENSE_FOR_75PROSENT_FORSKUDD_ENSLIG, tomDato)!!
        val forskudd75ProsentGift = sjablonger.hentSjablongForTomDato(SjablongType.ØVRE_INNTEKTSGRENSE_FOR_75PROSENT_FORSKUDD_GIFT_SAMB, tomDato)!!
        val inntekstIntervallForskudd = sjablonger.hentSjablongForTomDato(SjablongType.INNTEKTSINTERVALL_FORSKUDD, tomDato)!!
        val multiplikatorForskudd = sjablonger.hentSjablongForTomDato(SjablongType.MULTIPLIKATOR_MAKS_INNTGRENSE_FORSKUDD_MOTTAKER, tomDato)!!
        val forskuddSats = sjablonger.hentSjablongForTomDato(SjablongType.FORSKUDDSSATS, tomDato)!!
